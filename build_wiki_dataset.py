            ...
            if ( len(metadata) > 0 and re.search("(jpg|JPG|png|PNG)",realURL) ):
                ...
                if (not testpage):
                    try:
                        ...
                        tags.append(tag1)
                        thistile["comment"]="01_time : "+str(epoch_time)+" </br> "+thistile["comment"]
                    except:
                        if (DEBUG_tags):
                            traceback.print_exc(file=sys.stderr)
                        pass
                    try:
                        ...
                        tags.append(tag3)
                        thistile["comment"]="02_lon : "+data_lon+" </br> "+thistile["comment"]
                        thistile["comment"]="03_lat : "+data_lat+" </br> "+thistile["comment"]
                    except:
                        #traceback.print_exc(file=sys.stderr)
                        pass
                    try:
                        ...
                        tags.append(tag4)
                        thistile["comment"]="04_width : "+ma.group("width").replace(",",".")+" </br> "+thistile["comment"]
                        #Image height
                        tag5 = "{05_height,1,"+ma.group("height").replace(",",".")+",16000}"
                        tags.append(tag5)
                        thistile["comment"]="05_height : "+ma.group("height").replace(",",".")+" </br> "+thistile["comment"]
                        ...
                        tags.append(tag6)
                        thistile["comment"]="06_fsize : "+fsize+" </br> "+thistile["comment"]
                    except:
                        if (DEBUG_tags):
                            traceback.print_exc(file=sys.stderr)
                        pass
                    try:
                        ...
                        tags.append(tag7)
                        thistile["comment"]="07_expos : "+et+" </br> "+thistile["comment"]
                    except:
                        if (DEBUG_tags):
                            traceback.print_exc(file=sys.stderr)
                        pass
                    try:
                        ...
                        tags.append(tag8)
                        thistile["comment"]="08_focal : "+f+" </br> "+thistile["comment"]
                    except:
                        if (DEBUG_tags):
                            traceback.print_exc(file=sys.stderr)
                        pass
                    try:
                        ...
                        tags.append(tag9)
                        thistile["comment"]="09_shutsp : "+spe+" </br> "+thistile["comment"]
                    except:
                        if (DEBUG_tags):
                            traceback.print_exc(file=sys.stderr)
                        pass
                    try:
                        ...
                        tags.append(tag10)
                        thistile["comment"]="10_iso : "+iso+" </br> "+thistile["comment"]
                    except:
                        if (DEBUG_tags):
                            traceback.print_exc(file=sys.stderr)
                        pass
                    try:
                        ...
                        tags.append(tag11)
                        thistile["comment"]="11_aper : "+aper+" </br> "+thistile["comment"]
                    except:
                        if (DEBUG_tags):
                            traceback.print_exc(file=sys.stderr)
                        pass
